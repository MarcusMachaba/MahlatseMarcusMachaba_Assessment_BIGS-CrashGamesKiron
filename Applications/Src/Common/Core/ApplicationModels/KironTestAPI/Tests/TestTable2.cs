...
{
    [TableContract(Audited = true, PrimaryKey = nameof(Id))]        
    public class TestTable2 : HasIdOnly, IEquatable<TestTable2>
    {
        [DataMember, ColumnContract]
        public override long Id { get; set; }

        [DataMember, ColumnContract(ForeignKeyType = typeof(TestTable), Required = true, Queryable = true)]
        public long IdTestTable { get; set; }

        [ColumnContract(nameof(TestTable), nameof(IdTestTable), nameof(TestTable.UserName))]
        public string UserName { get; set; }

        [ColumnContract(nameof(TestTable), nameof(IdTestTable), nameof(TestTable.Email))]
        ...
        public bool Equals(TestTable2 other)
        {
            ...
            return IdTestTable == other.IdTestTable && string.Equals(Email, other.Email, StringComparison.OrdinalIgnoreCase);
        }
